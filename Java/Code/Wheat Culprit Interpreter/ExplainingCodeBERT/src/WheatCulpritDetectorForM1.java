...
//import ModelInterpreter.NewStatementVisitor;
...
public class WheatCulpritDetectorForM1 {


    static String PYTHON_VERSION = "python3";
    static String pythonTestFilePath = "pythontestfolder/test.java";
    ...
    static String culpritlogfile = "m1_culpritlog.csv";
    static String wheatlogfile = "m1_wheatlog.csv";
    ...
    public static void main(String args[]) throws Exception {
        ...
        while (javaFileIter.hasNext()) {
            ...
            parseFile();
            if(StatementVisitorform1.codePartsList.size()<=10) {
                int predictionFromOriginalFile = checkPredictionOfOriginalFile(currentFile);
                int predictionFromCodeParts = checkPredictionOfOriginalStatements(StatementVisitorform1.codePartsList);
    ...
    private static void writeCulpritOutputToFile(int predictionFromOriginalFile, int  predFromCodeParts, String culpritStatus) throws IOException {
        ...
        try {
            ...
            pw.println(d.toString()+","+ StatementVisitorform1.className+","+predictionFromOriginalFile+","+predFromCodeParts+","+culpritStatus+","+numCuplritStmts +","+ numMutations+","+ StatementVisitorform1.methodBody1Signature.replace(",",";")+","+ StatementVisitorform1.methodBody2Signature.replace(",",";")+","+culpritStmts);
    ...
    private static void writeWheatNecOutputToFile(String wheatStatus, int numStmts, String stmts) throws IOException {
        ...
        try {
            ...
            Date d = new Date();
            pw.println(d.toString()+","+ StatementVisitorform1.className+","+wheatStatus+","+numStmts +","+ numMutations+","+ stmts);
    ...
    private static boolean getSufficientCodePartsForComb(List<Integer> combination) throws IOException {
        ...
        for (int index : combination) {
            StatementVisitorform1.codePartsList.get(index).setProcessing(true);
        }
        String codePartsJoined = "";
        for (CodeParts cp : StatementVisitorform1.codePartsList) {
            if (cp.isProcessing())
        ...
        String program = "public class " + StatementVisitorform1.className + "Mod" + i + " { \n" +
                StatementVisitorform1.methodBody1Signature + "\n" +
                //"public {\n" +
                codePartsJoined +
                "}\n" +
                StatementVisitorform1.methodBody2 + "\n\n" +
                "}";
        ...
        try {
            ...
            FileWriter output2 = new FileWriter(mutationsOutputFolderPath + StatementVisitorform1.className + "SuffMod" + i + ".java");
        ...
        if (prediction == 1) {
            for (int index : combination) {
                StatementVisitorform1.codePartsList.get(index).setSufficient(true);
            }
        ...
        //else if flipped, set as not sufficient
            ...
            for (int index : combination) {
                StatementVisitorform1.codePartsList.get(index).setSufficient(false);
            }
        }
        ...
        for (int index : combination) {
            StatementVisitorform1.codePartsList.get(index).setProcessing(false);
        }
        //end for
    ...
    public static void parseFile() throws IOException {
        ...
        if (parse != null) {
            ...
            StatementVisitorform1 walk1 = new StatementVisitorform1();
            parse.accept(walk1);
        }
    }

    public static void resetCodeParts() {
        StatementVisitorform1.codePartsList = new ArrayList<>();
        StatementVisitorform1.codePartsListm2 = new ArrayList<>();
        StatementVisitorform1.methodBody1Signature = "";
        StatementVisitorform1.methodBody2 = "";
        StatementVisitorform1.methodBody1InnerStmts = "";
        StatementVisitorform1.methodBody2Signature = "";
        StatementVisitorform1.methodBody2InnerStmts = "";
        numCuplritStmts = 0;
        numNecStmts = 0;
        numWheatStmts = 0;
        culpritStmts = "";
    ...
    private static List<Integer> getNecessaryCodePartsKComb() throws IOException {
        ...
        int size = StatementVisitorform1.codePartsList.size();
            ...
            for (List<Integer> combination : statementIndices) {
                ...
                if(found == 0) {
                    ...
                    try {
                        ...
                        file.setReadable(true);
                        FileWriter output = new FileWriter(file);
                        FileWriter output2 = new FileWriter(mutationsOutputFolderPath+ StatementVisitorform1.className + "Mod" + i + ".java");
                    ...
                    if (prediction == 1) {
                        for (int index : combination) {
                            StatementVisitorform1.codePartsList.get(index).setNecessary(false);
                        }
                    }
                    ...
                    //else if flipped set as necessary
                        ...
                        numNecStmts = 0;
                        for (int index : combination) {
                            StatementVisitorform1.codePartsList.get(index).setNecessary(true);
                            numWheatStmts += 1;
                            numNecStmts += 1;
                        }
        ...
        for (int a = 1; a <= size - 1; a++) {
            ...
            for (List<Integer> combination : statementIndices) {
                ...
                if(found == 0) {
                    ...
                    //create new file with not processing codeparts
                    String program = "public class " + StatementVisitorform1.className + "CulpritMod" + i + " { \n" +
                            //"public void main(){\n" +
                            //"public {\n" +
                            codePartsJoined +
                            "}\n\n" +
                    ...
                    try {
                        ...
                        file.setReadable(true);
                        FileWriter output = new FileWriter(file);
                        FileWriter output2 = new FileWriter(mutationsOutputFolderPath+ StatementVisitorform1.className + "CulpritMod" + i + ".java");
                    ...
                    if (prediction == 0) {
                        for (int index : combination) {
                            StatementVisitorform1.codePartsList.get(index).setCulprit(false);
                        }
                    ...
                    //else of flipped set as culprit
                        ...
                        for (int index : combination) {
                            StatementVisitorform1.codePartsList.get(index).setCulprit(true);
                        }
    ...
    private static int checkPredictionOfOriginalStatements(List<CodeParts> codePartsList) throws IOException {
        ...
        //create new file
        String program = "public class "+ StatementVisitorform1.className+"AllCodeParts" +" { \n" +
                codePartsJoined +
                "}\n"+
                StatementVisitorform1.methodBody2 + "\n\n" +
                "}";
        ...
        try {
            ...
            file.setReadable(true);
            FileWriter output = new FileWriter(file);
            FileWriter output2 = new FileWriter(mutationsOutputFolderPath+ StatementVisitorform1.className+"AllCodeParts.java");
